          ...
          <div className="space-y-3">
            ...
            <div>
                ...
                {(isAndhraPradesh
                  ...
                  <button
                    ...
                    className={`rounded-lg px-2.5 py-1 text-[11px] font-bold transition-all cursor-pointer ${
                      profile.district?.toLowerCase() === d.toLowerCase()
                        ? "bg-[#0B1B4F] text-[#F5E29F] ring-1 ring-[#DFB738]"
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50/70 px-3.5 py-2.5 text-xs font-semibold text-slate-900 focus:border-amber-600 focus:bg-white focus:outline-hidden mb-2"
              />
              ...
              <input
                ...
                placeholder={isAndhraPradesh ? "e.g. Governorpet, Ward 14, Arundelpet" : "e.g. Triplicane, Anna Nagar, Simmakkal"}
                className="w-full rounded-xl border border-slate-200 bg-slate-50/70 px-3.5 py-2.5 text-xs font-semibold text-slate-900 focus:border-amber-600 focus:bg-white focus:outline-hidden"
              />
              <p className="text-[10px] text-slate-500 mt-1">
                Offline Seva centers & Sachivalayams will automatically localize to this area.
              </p>
            </div>
          </div>
        </div>
